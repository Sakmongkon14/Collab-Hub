                            ...
                            <div class="accordion-body">
                                <div class="container input-group mb-3 input-group-sm  py-3 row g-3 custom-form">
                                    <div class="status-row">
                                        ...
                                        <div
                                            style="display: flex; justify-content: center; align-items: center; gap: 100px; max-width: 1200px; margin: 10px auto; position: relative; height: 20px;">

                                            <!-- เส้นพื้นหลัง -->
                                            <div
                                                style="position: absolute; top: 65%; left: 0; right: 0; height: 4px; background-color: #ccc; z-index: 0;">
                                            </div>

                                            <!-- เส้นความคืบหน้า -->
                                            <div
                                                style="position: absolute; top: 65%; left: 0; height: 4px; background-color: #00FF00; width: 40%; z-index: 1;">
                                            </div>

                                            <!-- Step 1: Completed -->
                                            <div
                                                style="position: relative; z-index: 2; display: flex; flex-direction: column; align-items: center;">
                                                <div style="text-align: center; margin-bottom: 8px;">PR</div>
                                                <div
                                                    style="width: 40px; height: 40px; border-radius: 50%; background-color: #6b46c1; color: white; display: flex; align-items: center; justify-content: center;">
                                                    ✓
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                style="position: relative; z-index: 2; display: flex; flex-direction: column; align-items: center;">
                                                <div style="text-align: center; margin-bottom: 8px;">WO</div>
                                                <div
                                                    style="width: 40px; height: 40px; border-radius: 50%; background-color: #6b46c1; color: white; display: flex; align-items: center; justify-content: center;">
                                                    ✓
                                                </div>
                                            ...
                                            <div
                                                style="position: relative; z-index: 2; display: flex; flex-direction: column; align-items: center;">
                                                <div style="text-align: center; margin-bottom: 8px;">Billing</div>
                                                <div
                                                    style="width: 40px; height: 40px; border-radius: 50%; border: 2px solid #6b46c1; background-color: white; display: flex; align-items: center; justify-content: center; position: relative;">
                                                    <div
                                                        style="width: 12px; height: 12px; background-color: #6b46c1; border-radius: 50%;">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-3 d-flex align-items-center flex-wrap mt-2 p-2"
                                    style="background: #f8f9fa; border-radius: 8px; border: 1px solid #e3e3e3;">

                                    <!-- ย้ายออกมานอก d-flex หรือใช้ w-100 -->
                                    <div class="w-100 mb-2 ms-2 fw-bold text-primary">
                                        Quotation
                                    </div>

                                    <div class="d-flex align-items-center mb-3 ms-2">
                                        <label for="pile_supplier" class="ms-1" style="width:120px;">Quotation
                                            No.</label>
                                        <div class="d-flex flex-column">
                                            <input list="prList" name="Quotation" id="Quotation"
                                                class="form-control" style="width:160px;"
                                                placeholder="เลือกหรือพิมพ์ PR No."
                                                value="{{ old('Quotation', $blog->pile_supplier) }}">

                                            <datalist id="prList">
                                                @foreach ($prList as $item)
                                                    <option value="{{ $item->PR_MR_No }}"></option>
                                                @endforeach
                                            </datalist>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center mb-3 ms-2">
                                        <label for="Quotation_Amount" class="ms-1" style="width: 120px;">Quotation
                                            Amount.</label>
                                        <div class="d-flex flex-column">
                                            <input type="number" name="Quotation_Amount" class="form-control"
                                                placeholder="กรุณากรอกตัวเลข" style="width: 160px;"
                                                value="{{ $blog->price }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center mb-3 ms-2">
                                        <label for="pile_supplier_accept_date" class="me-1 ms-2"
                                            style="width: 140px;">Quotation Date</label>
                                        <div class="flex-grow-1 position-relative">
                                            <input type="text" id="pile_supplier_accept_date"
                                                name="pile_supplier_accept_date" style="width: 160px;"
                                                class="form-control datepicker pe-5" placeholder="วันที่-เดือน-ปี"
                                                value="{{ old('pile_supplier_accept_date', $blog->pile_supplier_accept_date) }}">
                                            <!--DATE -->
                                            <i
                                ...
                                <div class="col-md-3 d-flex align-items-center flex-wrap  p-2"
                                    style="background: #f8f9fa; border-radius: 8px; border: 1px solid #e3e3e3;">
                                    ...
                                    <div class="d-flex align-items-center mb-3 ms-2">
                                        <label for="accept_1" class="me-4" style="width: 100px;">PR No.</label>

                                        <div class="flex-grow-1 position-relative">
                                            <input type="text" id="accept_1" name="accept_1"
                                                style="width: 160px;" class="form-control readonly-input"
                                                placeholder="Export PR โดยใช้ Refcode." readonly
                                                value="{{ old('accept_1', $blog->accept_1) }}"> <!--DATE -->
                                        </div>
                                    </div>

                                    <div class="d-flex align-items-center mb-3 ms-2">
                                        <label for="accept_1" class="me-4" style="width: 100px;">PR
                                            Amount</label>

                                        <div class="flex-grow-1 position-relative">
                                            <input type="text" id="accept_1" name="accept_1"
                                                style="width: 160px;" class="form-control readonly-input"
                                                placeholder="Export PR โดยใช้ PR No." readonly
                                                value="{{ old('accept_1', $blog->accept_1) }}"> <!--DATE -->
                                        </div>
                                    </div>

                                    <div class="d-flex align-items-center mb-3 ms-2">
                                        <label for="accept_1" class="me-4" style="width: 130px;">PR submitted
                                            Date</label>

                                        <div class="flex-grow-1 position-relative">
                                            <input type="text" id="accept_1" name="accept_1"
                                                style="width: 160px;" class="form-control readonly-input"
                                                placeholder="ดึงมาจากไฟล์ Export PR" readonly
                                                value="{{ old('accept_1', $blog->accept_1) }}"> <!--DATE -->
                                            <!--DATE -->
                                            <i
                                                class="bi bi-calendar position-absolute top-50 end-0 translate-middle-y pe-2"></i>
                                    ...
                                    <div class="d-flex align-items-center mb-3 ms-2">
                                        <label for="accept_1" class="me-4" style="width: 100px;">PR Approved
                                            Date</label>

                                        <div class="flex-grow-1 position-relative">
                                            <input type="text" id="accept_1" name="accept_1"
                                                style="width: 160px;" class="form-control readonly-input"
                                                placeholder="ดึงมาจากไฟล์ Export PR"
                                                value="{{ old('accept_1', $blog->accept_1) }}" readonly>
                                            <!--DATE -->
                                            <!--DATE -->
                                            <i
                                                class="bi bi-calendar position-absolute top-50 end-0 translate-middle-y pe-2"></i>
                                ...
                                <div class="col-md-3 d-flex align-items-center flex-wrap  p-2"
                                    ...
                                    <div class="d-flex align-items-center mb-3 ms-2">
                                        <label for="accept_1" class="me-4" style="width: 100px;">WO No.</label>

                                        <div class="flex-grow-1 position-relative">
                                            <input type="text" id="accept_1" name="accept_1"
                                                style="width: 160px;" class="form-control readonly-input"
                                                placeholder="Export Wo โดยใช้ Pr No." readonly
                                                value="{{ old('accept_1', $blog->accept_1) }}"> <!--DATE -->
                                        </div>
                                    </div>

                                    <div class="d-flex align-items-center mb-3 ms-2">
                                        <label for="accept_1" class="me-4" style="width: 100px;">WO
                                            Amount</label>

                                        <div class="flex-grow-1 position-relative">
                                            <input type="text" id="accept_1" name="accept_1"
                                                style="width: 160px;" class="form-control readonly-input"
                                                placeholder="Export Wo โดยใช้ WO No." readonly
                                                value="{{ old('accept_1', $blog->accept_1) }}"> <!--DATE -->
                                        </div>
                                    </div>

                                    <div class="d-flex align-items-center mb-3 ms-2">
                                        <label for="accept_1" class="me-4" style="width: 130px;">WO submitted
                                            Date</label>

                                        <div class="flex-grow-1 position-relative">
                                            <input type="text" id="accept_1" name="accept_1"
                                                style="width: 160px;" class="form-control readonly-input"
                                                placeholder="ดึงมาจากไฟล์ Export WO" readonly
                                                value="{{ old('accept_1', $blog->accept_1) }}"> <!--DATE -->
                                            <!--DATE -->
                                            <i
                                                class="bi bi-calendar position-absolute top-50 end-0 translate-middle-y pe-2"></i>
                                    ...
                                    <div class="d-flex align-items-center mb-1 ms-2">
                                        <label for="accept_1" class="me-4" style="width: 100px;">WO Approved
                                            Date</label>

                                        <div class="flex-grow-1 position-relative">
                                            <input type="text" id="accept_1" name="accept_1"
                                                style="width: 160px;" class="form-control readonly-input"
                                                placeholder="ดึงมาจากไฟล์ Export WO"
                                                value="{{ old('accept_1', $blog->accept_1) }}" readonly>
                                            <!--DATE -->
                                            <!--DATE -->
                                            <i
